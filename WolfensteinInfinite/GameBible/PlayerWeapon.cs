...
{
    public class PlayerWeapon(string name, int preferedOrder, WeaponType weaponType, AmmoType ammoType, string? sound,int baseHeight, int fireRate,string hudSprite, string spritePath, int startSprite, int spriteCount, int fireIndex, int firingStart, int firingEnd)
    {
