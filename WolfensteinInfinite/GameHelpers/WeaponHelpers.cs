...
namespace WolfensteinInfinite.GameHelpers
{
    public static class WeaponHelpers
    {
        ...
        public static Weapon CreateMachineGun(string? sound) => new("MachineGun", WeaponType.MACHINE_GUN, "Bullet", sound, 4, 1,2);
        public static Weapon CreateChainGun(string? sound) => new("ChainGun", WeaponType.CHAIN_GUN, "Bullet", sound, 8, 1,3);
