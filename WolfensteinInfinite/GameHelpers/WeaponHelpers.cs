...
namespace WolfensteinInfinite.GameHelpers
{
    public static class WeaponHelpers
    {
        ...
        public static Weapon CreateMachineGun(string? sound) => new("MachineGun", WeaponType.MACHINE_GUN, "Bullet", sound, 4, 1);
        public static Weapon CreateChainGun(string? sound) => new("ChainGun", WeaponType.CHAIN_GUN, "Bullet", sound, 8, 1);
        ...
        public static Weapon CreateFlameThrower(string? sound) => new("FlameThrower", WeaponType.FLAME_THROWER, "Flame", sound, 1, 1);
