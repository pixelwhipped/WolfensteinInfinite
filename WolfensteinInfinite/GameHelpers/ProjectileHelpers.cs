...
namespace WolfensteinInfinite.GameHelpers
{
    public static class ProjectileHelpers
    {
        ...
        public static Projectile CreateMagicalOrb(string name, ProjectileSpriteType spriteType, string spritePath, int spriteStart, string? hitsound, string? trailAnimation, string? impactAnimation) => new(name, 8, 10, AmmoType.SERUM, 5f, spriteType, spritePath, spriteStart, hitsound, trailAnimation, impactAnimation);
    }
}
