...
namespace WolfensteinInfinite.GameHelpers
{
    ...
    {
        public static Projectile CreateBullet(string name, string? hitsound, string? trailAnimation, string? impactAnimation) => new(name, 6, 13, AmmoType.BULLET, ProjectileSpriteType.BULLET, null, -1, hitsound, trailAnimation, impactAnimation);
        ...
        public static Projectile CreateSerum(string name, ProjectileSpriteType spriteType, string spritePath, int spriteStart, string? hitsound, string? trailAnimation, string? impactAnimation) => new(name, 8, 9, AmmoType.SERUM, spriteType, spritePath, spriteStart, hitsound, trailAnimation, impactAnimation);
